...
typealias RabbitNameEditHandler = (editName:String) -> Void
...
class NameViewController: UIViewController {
    ...
    var editHandler:RabbitNameEditHandler?
    ...
    @IBAction func closureSaved(sender: AnyObject) {
        
        self.editHandler?(editName: self.rabitNameTextField.text!)
        self.dismissViewControllerAnimated(true, completion: nil)
    }
    /*
    // MARK: - Navigation
